...
//	battery is 250 and then plays the games till battery is less or equal to 50.
	...
	public void entertain(){
		...
		System.out.println("Num movie played for iPhone : "+numMovie+", Battery left : "+varBatterylifeMovie);
		...
		System.out.println("Num Games played for iPhone : "+numGame+", Battery left : "+varBatterylifeGame);
	}
}
